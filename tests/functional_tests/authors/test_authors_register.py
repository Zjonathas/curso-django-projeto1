...
class AuthorsRegisterTest(AuthorsBaseTest):
    ...
    def test_empty_first_name_error_message(self):
        ...
        first_name_field = self.get_by_placeholder(form, 'Ex.: Jonathas')
    ...
    def test_empty_username_name_error_message(self):
        ...
        first_name_field = self.get_by_placeholder(form, 'Your username')
        first_name_field.send_keys(' ')
        first_name_field.send_keys(Keys.ENTER)
    ...
    def test_empty_password_error_message(self):
        ...
        first_name_field = self.get_by_placeholder(form, 'Type your password')
        first_name_field.send_keys(' ')
        first_name_field.send_keys(Keys.ENTER)
